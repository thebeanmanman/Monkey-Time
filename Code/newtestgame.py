...
def Skin(sken):
    ...
    if sken == "menkey":
        ...
        sky = pygame.image.load("treeness.jpg")
        sky = pygame.transform.scale(sky, (1500, 1200))
        grass = pygame.image.load("swampness.jpg")
        grass = pygame.transform.scale(grass, (1500, 300))
    elif sken == "sw":
        sky = pygame.image.load("startar.jpg")
        sky = pygame.transform.scale(sky, (1500, 1200))
        grass = pygame.image.load("totallyhangar.jpg")
        grass = pygame.transform.scale(grass, (1500, 300))
        if randint(0,1) == 0:
            ...
            player3img = pygame.image.load("sidious.png")
            player4img = pygame.image.load("dooku.png")
