...
def Skin(sken):
    ...
    if sken == "menkey":
        ...
        blacke = pygame.image.load("brownbanan.png").convert_alpha()
        bluee = pygame.image.load("greenbanan.png").convert_alpha()
        sky = pygame.image.load("sky1.jpg").convert()
        sky = pygame.transform.scale(sky, (1500, 1200))
        grass = pygame.image.load("grass1.jpg").convert()
        ...
        yellowe = pygame.image.load("fly.png").convert_alpha()
        blacke = pygame.image.load("wasp.png").convert_alpha()
        bluee = pygame.image.load("dragonfly.png").convert_alpha()
        sky = pygame.image.load("treeness.jpg").convert()
        sky = pygame.transform.scale(sky, (1500, 1200))
        grass = pygame.image.load("swampness.jpg").convert()
        grass = pygame.transform.scale(grass, (1500, 300))
    elif sken == "sw":
        sky = pygame.image.load("startar.jpg").convert()
        sky = pygame.transform.scale(sky, (1500, 1200))
        grass = pygame.image.load("totallyhangar.jpg").convert()
        grass = pygame.transform.scale(grass, (1500, 300))
        if randint(0,1) == 0:
            player1img = pygame.image.load("luke.png").convert_alpha()
            player2img = pygame.image.load("obiobi.png").convert_alpha()
            player3img = pygame.image.load("ahsoka.png").convert_alpha()
            player4img = pygame.image.load("seagulls.png").convert_alpha()
            yellowe = pygame.image.load("bluelight.png").convert_alpha()
            blacke = pygame.image.load("redlight.png").convert_alpha()
            bluee = pygame.image.load("jediholo.png").convert_alpha()
            swselect = pygame.image.load("luke.png").convert_alpha()
        else:
            player1img = pygame.image.load("vader.png").convert_alpha()
            player2img = pygame.image.load("maul.png").convert_alpha()
            player3img = pygame.image.load("sidious.png").convert_alpha()
            player4img = pygame.image.load("dooku.png").convert_alpha()
            yellowe = pygame.image.load("redlight.png").convert_alpha()
            blacke = pygame.image.load("bluelight.png").convert_alpha()
            bluee = pygame.image.load("sithholo.png").convert_alpha()
            swselect = pygame.image.load("vader.png").convert_alpha()
...
try:
    ...
    ticicon = pygame.image.load("ticicon.png").convert_alpha()
